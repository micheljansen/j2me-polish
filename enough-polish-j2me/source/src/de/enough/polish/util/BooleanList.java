...
/**
 * <p>Provides an flexible list for storing boolean primitives.</p>
...
implements Externalizable
{
	 ...
	 */
	public BooleanList( int initialCapacity, int growthFactor ) {
	...
	/**
	 * Determines whether the given boolean is stored in this list.
	 * 
	 * @param element the boolean which might be stored in this list
	 ...
	 * 
	 * @param element the boolean which is part of this list.
	...
	/**
	 * Returns the boolean at the specified position in this list.
	 *  
	 * @param index the position of the desired element.
	 * @return the boolean stored at the given position
	...
	/**
	 * Removes the boolean at the specified position in this list.
	 *  
	 * @param index the position of the desired boolean.
	 * @return the boolean stored at the given position
	 * @throws IndexOutOfBoundsException when the index < 0 || index >= size()
	 */
	public boolean removeElementAt( int index ) {
		...
		boolean removed = this.storedObjects[ index ];
	...
	/**
	 * Removes the (first) given boolean.
	 * 
	 * @param element the boolean which should be removed.
	 ...
	 * Any following booleans are shifted one position to the back.
	 * 
	 ...
	 * @param element the boolean which should be inserted
	 * @throws IndexOutOfBoundsException when the index < 0 || index >= size()
	 */
	...
	/**
	 * Replaces the boolean at the specified position in this list with the specified boolean. 
	 * 
	 * @param index the position of the element, the first element has the index 0.
	 * @param element the boolean which should be set
	...
	public boolean set( int index, boolean element ) {
		...
		boolean replaced = this.storedObjects[ index ];
		this.storedObjects[ index ] = element;
		return replaced;
	}
	...
	public boolean[] toArray() {
		boolean[] copy = new boolean[ this.size ];
	...
	public void trimToSize() {
		if (this.storedObjects.length != this.size ) {
			boolean[] newStore = new boolean[ this.size ];

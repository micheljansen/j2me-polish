...
public interface StopTimeControl extends Control
{
	 ...
	 * <P>
	 * 
	 * @param stopTime - The time in microseconds at which you want the Player to stop, in media time.
	 * @throws java.lang.IllegalStateException - Thrown if setStopTime is called on a started Player and the media stop-time has already been set.
	 * @see #getStopTime()
	 */

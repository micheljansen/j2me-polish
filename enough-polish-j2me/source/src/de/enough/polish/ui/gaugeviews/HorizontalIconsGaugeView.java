...
public class HorizontalIconsGaugeView extends ItemView {
	...
	protected void setStyle(Style style) {
		...
		image = style.getProperty("gauge-horizontal-icons-image");
		if (image != null) {
			try
			{
		...
		countObj = style.getIntProperty("gauge-horizontal-icons-count");
		if (countObj != null) {
		...
		image = style.getProperty("gauge-horizontal-icons-highlight-image");
		if (image != null) {
			try
			{
		...
		countObj = style.getIntProperty("gauge-horizontal-icons-highlight-count");
		if (countObj != null) {
		...
		image = style.getProperty("gauge-horizontal-icons-highlight-center-image");
		if (image != null) {
			try
			{

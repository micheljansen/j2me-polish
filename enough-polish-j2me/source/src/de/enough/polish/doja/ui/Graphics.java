...
public class Graphics extends Object
{
	...
	public com.nttdocomo.ui.Graphics g;
	...
	public void setColor(int red, int green, int blue)
	{
		...
		// getColorOfRGB retrieves a color that's valid for the current device:
		this.g.setColor( com.nttdocomo.ui.Graphics.getColorOfRGB(red, green, blue ) );
	}
	...
	{
		setColor( RGB >> 16, (RGB >> 8) & 0x00FF, RGB & 0x0000FF );
	}
   ...
   * @see #setClip(int, int, int, int)
	...
	public void drawString( String str, int x, int y, int anchor)
	{
		if (( anchor & RIGHT ) == RIGHT ) {
			x -= this.font.font.stringWidth( str );
   ...
   * @see #drawChars(char[], int, int, int, int, int)
	...
	{
		if (anchor == (TOP | LEFT)) {
			this.g.drawChars( data, x + this.translateX, y + this.translateY, offset, length );
		}
	...
	{
		com.nttdocomo.ui.Image bitmap = img.bitmap;
		...
		this.g.drawImage(bitmap, x + this.translateX, y + this.translateY );
	}
	...
	public void drawRegion( Image src, int x_src, int y_src, int width, int height, int transform, int x_dest, int y_dest, int anchor)
	{
		...
		this.g.drawImage(src.bitmap, x_dest + this.translateX, y_dest + this.translateY ); //, width, height, src.bitmap, x_src, y_src );
		//TODO allow transformation by using a matrix
	}
	...
	public void fillTriangle(int x1, int y1, int x2, int y2, int x3, int y3)
	{
		...
		this.g.fillPolygon( xPositions, yPositions, 3 );
	}
	...
	{
		com.nttdocomo.ui.Image image = com.nttdocomo.ui.Image.createImage( width, height, rgbData, offset );
		this.g.drawImage(image, x + this.translateX, y + this.translateY );
	}

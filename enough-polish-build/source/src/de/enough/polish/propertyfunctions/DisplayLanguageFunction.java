...
/**
 * <p>Gets a locale like "fr" or "en_US" and returns the localized language name for this.</p>
 ...
 */
public class DisplayLanguageFunction extends PropertyFunction {

	/**
	 * Create a new function
	 */
	public DisplayLanguageFunction() {
		super();
	}
	...
	public String process(String input, String[] arguments, Environment env) {
		...
		//System.out.println("Locale: " + input + "==" + locale.toString() + ", displaylanguage=" + locale.getDisplayLanguage(locale));
